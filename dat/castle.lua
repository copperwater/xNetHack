...
des.level_flags("mazelevel", "noteleport", "graveyard", "noflipy")
...
des.door({ state = "closed", x=32, y=04, iron = 1 })
if percent(50) then
   des.door("closed",26,05)
else
   des.door("closed",15,05)
end
des.door({ state = "locked", x=46, y=05, iron = 1 })
des.door({ state = "locked", x=48, y=05, iron = 1 })
des.door("locked",47,07)
des.door({ state = "closed", x=15, y=08, iron = 1 })
des.door({ state = "closed", x=26, y=08, iron = 1 })
des.door("locked",38,08)
des.door({ state = "locked", x=56, y=08, iron = 1 })
des.door("locked",47,09)
if percent(50) then
   des.door("closed",26,11)
else
   des.door("closed",15,11)
end
des.door({ state = "locked", x=46, y=11, iron = 1 })
des.door({ state = "locked", x=48, y=11, iron = 1 })
des.door({ state = "locked", x=32, y=12, iron = 1 })
...
local mat = percent(25) and "glass" or (percent(50) and "iron" or "wooden")
