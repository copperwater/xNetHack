...
#define SPELL(name,desc,sub,prob,level,mgc,dir,color)  \
    OBJECT(OBJ(name, desc),                                             \
           ...
           0, SPBOOK_CLASS, prob, level * 10, 50, level * 100,          \
...
SPELL("sleep",           "mottled",
      P_ENCHANTMENT_SPELL, 50,  1, 1, RAY, HI_PAPER),
...
SPELL("slow monster",    "light green",
      P_ENCHANTMENT_SPELL, 30,  2, 1, IMMEDIATE, CLR_BRIGHT_GREEN),
...
SPELL("restore ability", "light brown",
      P_HEALING_SPELL,     25,  4, 1, NODIR, CLR_BROWN),
