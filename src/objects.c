...
SPELL("dig",             "parchment",
      P_MATTER_SPELL,      20,  5, 1, RAY, HI_PAPER),
...
SPELL("detect monsters", "leathery",
      P_DIVINATION_SPELL,  43,  1, 1, NODIR, HI_LEATHER),
SPELL("healing",         "white",
...
SPELL("cure blindness",  "yellow",
      P_HEALING_SPELL,     25,  2, 1, IMMEDIATE, CLR_YELLOW),
...
SPELL("invisibility",    "dark brown",
      P_ESCAPE_SPELL,      25,  4, 1, NODIR, CLR_BROWN),
...
SPELL("jumping",         "thin",
      P_ESCAPE_SPELL,      20,  1, 1, IMMEDIATE, HI_PAPER),
