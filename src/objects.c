...
WEAPON("halberd", "angled poleaxe",
       0, 0, 1, 14, 150,  10, 10,  6, 0, P|S, P_POLEARMS, IRON, HI_METAL),
        /* +1d6 large */
...
TOOL("magic marker",        None, 1, 0, 1, 1, 15,  2,200, PLASTIC, CLR_RED),
/* traps */
...
/* spellbooks ... */
     ...
     */
#define SPELL(name,desc,sub,prob,level,mgc,dir,color)  \
    OBJECT(OBJ(name, desc),                                             \
...
SPELL("dig",             "parchment",
      P_MATTER_SPELL,      20,  3, 1, RAY, HI_LEATHER),
SPELL("magic missile",   "vellum",
      P_ATTACK_SPELL,      45,  2, 1, RAY, HI_LEATHER),
#undef PAPER /* revert to normal material */
SPELL("fireball",        "ragged",
      P_ATTACK_SPELL,      20,  4, 1, RAY, HI_PAPER),
SPELL("cone of cold",    "dog eared",
      P_ATTACK_SPELL,      10,  4, 1, RAY, HI_PAPER),
SPELL("sleep",           "mottled",
      P_ENCHANTMENT_SPELL, 50,  2, 1, RAY, HI_PAPER),
SPELL("finger of death", "stained",
      P_ATTACK_SPELL,       5,  7, 1, RAY, HI_PAPER),
SPELL("light",           "cloth",
      P_DIVINATION_SPELL,  45,  1, 1, NODIR, HI_CLOTH),
