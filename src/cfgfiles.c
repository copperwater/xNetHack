...
/* xNetHack-added player-side options: */
...
/* xNetHack-added sysconf options: */
...
/* constructed full path names don't need fqname() */
    ...
    if (envp) {
        /* keep 'tmp_config' intact here; if alternates fail, use it to
           restore configfile[] to its preferred setting (".xnethackrc") */
...
/* xNetHack-added player-config-file options */
staticfn boolean
