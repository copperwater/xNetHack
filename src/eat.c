...
staticfn void givit(struct permonst *);
staticfn void eye_of_newt_buzz(struct permonst *);
...
is_edible(struct obj *obj)
{
    ...
    if (can_eat_material(gy.youmonst.data, obj->material))
        return TRUE;
