...
init_tilemap(void)
{
    ...
    for (i = 0; i < NUMMONS; i++) {
        ...
        tilemap[GLYPH_PEACEFUL_OFF + i].tilenum = tilenum;
...
{S_vbeam,    "vertical beam", "cmap 67"},
{S_hbeam,    "horizontal beam", "cmap 68"},
{S_lslant,   "left slant beam", "cmap 69"},
{S_rslant,   "right slant beam", "cmap 70"},
{S_digbeam,  "dig beam", "cmap 71"},
{S_flashbeam, "flash beam", "cmap 72"},
{S_boomleft, "boom left", "cmap 73"},
{S_boomright, "boom right", "cmap 74"},
{S_ss1,      "shield1", "cmap 75"},
{S_ss2,      "shield2", "cmap 76"},
{S_ss3,      "shield3", "cmap 77"},
{S_ss4,      "shield4", "cmap 78"},
{S_poisoncloud, "poison cloud", "poison cloud"},
{S_goodpos,  "valid position", "valid position"},
{S_sw_tl,    "swallow top left", "cmap 81"},
{S_sw_tc,    "swallow top center", "cmap 82"},
{S_sw_tr,    "swallow top right", "cmap 83"},
{S_sw_ml,    "swallow middle left", "cmap 84"},
{S_sw_mr,    "swallow middle right", "cmap 85"},
{S_sw_bl,    "swallow bottom left ", "cmap 86"},
{S_sw_bc,    "swallow bottom center", "cmap 87"},
{S_sw_br,    "swallow bottom right", "cmap 88"},
