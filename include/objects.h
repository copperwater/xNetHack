...
TOOL("magic whistle",  "whistle", 0, 0, 1, 0, 30, 3, 10, METAL, HI_METAL,
                                                                MAGIC_WHISTLE),
TOOL("flute",              NoDes, 1, 0, 0, 0,  4, 5, 12, WOOD, HI_WOOD,
                                                                FLUTE),
...
TOOL("harp",               NoDes, 1, 0, 0, 0,  4, 30, 50, WOOD, HI_WOOD,
                                                                HARP),
...
SPELL("sleep",           "mottled",
      P_ENCHANTMENT_SPELL, 50,  2, 1, RAY, HI_PAPER, SPE_SLEEP),
...
SPELL("cure blindness",  "yellow",
      P_HEALING_SPELL,     25,  0, 1, IMMEDIATE, CLR_YELLOW,
                                                        SPE_CURE_BLINDNESS),
...
SPELL("invisibility",    "dark brown",
      P_ESCAPE_SPELL,      25,  0, 1, NODIR, CLR_BROWN,
                                                        SPE_INVISIBILITY),
...
WAND("create monster",  "maple", 45, 200, 1, NODIR, WOOD, HI_WOOD,
                                                    WAN_CREATE_MONSTER),
WAND("wishing",          "pine",  5,5000, 1, NODIR, WOOD, HI_WOOD,
                                                    WAN_WISHING),
