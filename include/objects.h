...
PROJECTILE("elven arrow", "runed arrow",
           0, 20, 1, 2, 7, 6, 0,        COPPER, -P_BOW, HI_COPPER,
                                                        ELVEN_ARROW),
...
PROJECTILE("arrow of light", NoDes,
           1, 0, 0, 100, 8, 8, 0,       HARD_LIGHT, -P_BOW, CLR_WHITE,
                                                        ARROW_OF_LIGHT),
...
WEAPON("partisan", "vulgar polearm",
       0, 0, 1, 16,  80,  10,  6,  6, 0, P,   P_POLEARMS, IRON, HI_METAL,
                                                        PARTISAN),
        /* +1 large */
WEAPON("glaive", "single-edged polearm",
       0, 0, 1, 17,  75,   6,  6, 10, 0, S,   P_POLEARMS, IRON, HI_METAL,
                                                        GLAIVE),
/* axe-type */
...
WEAPON("bec de corbin", "beaked polearm",
       0, 0, 1, 17, 100,   8,  4,  6, 0, B|P, P_POLEARMS, IRON, HI_METAL,
                                                        BEC_DE_CORBIN),
...
WEAPON("quarterstaff", "staff",
       0, 0, 1, 11,  40,   5,  4,  6, 0, B,   P_QUARTERSTAFF, WOOD, HI_WOOD,
                                                        QUARTERSTAFF),
/* two-piece */
...
ARMOR("orcish ring mail", "crude ring mail",
      0, 0, 0,  0, 19, 5, 250,  60,  8, 1,  ARM_SUIT, IRON, CLR_BLACK,
                                                        ORCISH_RING_MAIL),
ARMOR("light armor", NoDes,
...
RING("see invisible", "engagement",
     SEE_INVIS,                150, 1, 0,  5, METAL, HI_METAL,
                                                        RIN_SEE_INVISIBLE),
RING("protection from shape changers", "shiny",
     PROT_FROM_SHAPE_CHANGERS, 100, 1, 0,  5, METAL, CLR_BRIGHT_CYAN,
...
TOOL("tin opener",          NoDes, 1, 0, 0, 0, 35,  4, 30, IRON, HI_METAL,
                                                                TIN_OPENER),
TOOL("can of grease",       NoDes, 1, 0, 0, 1, 15, 15, 20, PLASTIC,
                                               CLR_BRIGHT_BLUE, CAN_OF_GREASE),
TOOL("figurine",            NoDes, 1, 0, 1, 0, 25, 50, 80, MINERAL, HI_MINERAL,
                                                                FIGURINE),
        /* monster type specified by obj->corpsenm */
TOOL("magic marker",        NoDes, 1, 0, 1, 1, 15,  2,200, PLASTIC, CLR_RED,
                                                                MAGIC_MARKER),
/* traps */
...
TOOL("magic whistle",  "whistle", 0, 0, 1, 0, 30, 3, 100, METAL, HI_METAL,
                                                                MAGIC_WHISTLE),
TOOL("mundane flute",    "flute", 0, 0, 0, 0,  4, 5, 12, WOOD, HI_WOOD,
                                                                MUNDANE_FLUTE),
...
TOOL("mundane harp",      "harp", 0, 0, 0, 0,  4, 30, 50, WOOD, HI_WOOD,
                                                                MUNDANE_HARP),
...
SCROLL("magic mapping",              "ELAM EBOW",  1,  45, 100,
							SCR_MAGIC_MAPPING),
SCROLL("water",            "EGULED EL IOM SERPA",  1,  35, 200,
                                                        SCR_WATER),
...
/* spellbooks ... */
     ...
     */
#define SPELL(name,desc,sub,prob,level,mgc,dir,color,sn)  \
    OBJECT(OBJ(name, desc),                                             \
           BITS(0, 0, 0, 0, mgc, 0, 0, 0, 0, 0, dir, sub, PAPER),       \
           0, SPBOOK_CLASS, prob, level * 10, level * 5 + 30,           \
...
SPELL("fireball",        "ragged",
      P_ATTACK_SPELL,      20,  4, 1, RAY, HI_PAPER, SPE_FIREBALL),
SPELL("cone of cold",    "dog eared",
      P_ATTACK_SPELL,      10,  4, 1, RAY, HI_PAPER, SPE_CONE_OF_COLD),
SPELL("sleep",           "mottled",
      P_ENCHANTMENT_SPELL, 50,  3, 1, RAY, HI_PAPER, SPE_SLEEP),
SPELL("finger of death", "stained",
      P_ATTACK_SPELL,       5,  7, 1, RAY, HI_PAPER, SPE_FINGER_OF_DEATH),
SPELL("light",           "cloth",
      P_DIVINATION_SPELL,  45,  1, 1, NODIR, HI_CLOTH, SPE_LIGHT),
SPELL("detect monsters", "leathery",
      P_DIVINATION_SPELL,  43,  3, 1, NODIR, HI_LEATHER,
                                                        SPE_DETECT_MONSTERS),
SPELL("healing",         "white",
...
SPELL("cure blindness",  "yellow",
      P_HEALING_SPELL,      0,  2, 1, IMMEDIATE, CLR_YELLOW,
                                                        SPE_CURE_BLINDNESS),
SPELL("drain life",      "velvet",
      P_ATTACK_SPELL,      10,  3, 1, IMMEDIATE, CLR_MAGENTA,
                                                        SPE_DRAIN_LIFE),
...
SPELL("detect food",     "cyan",
      P_DIVINATION_SPELL,   0,  2, 1, NODIR, CLR_CYAN,
                                                        SPE_DETECT_FOOD),
SPELL("cause fear",      "light blue",
      P_ENCHANTMENT_SPELL, 25,  3, 1, NODIR, CLR_BRIGHT_BLUE,
                                                        SPE_CAUSE_FEAR),
SPELL("clairvoyance",    "dark blue",
      P_DIVINATION_SPELL,  15,  2, 1, NODIR, CLR_BLUE,
                                                        SPE_CLAIRVOYANCE),
SPELL("cure sickness",   "indigo",
      P_HEALING_SPELL,     32,  3, 1, NODIR, CLR_BLUE,
                                                        SPE_CURE_SICKNESS),
SPELL("charm monster",   "magenta",
      P_ENCHANTMENT_SPELL, 20,  6, 1, IMMEDIATE, CLR_MAGENTA,
                                                        SPE_CHARM_MONSTER),
SPELL("haste self",      "purple",
      P_ESCAPE_SPELL,      33,  3, 1, NODIR, CLR_MAGENTA,
                                                        SPE_HASTE_SELF),
SPELL("detect unseen",   "violet",
      P_DIVINATION_SPELL,  20,  2, 1, NODIR, CLR_MAGENTA,
                                                        SPE_DETECT_UNSEEN),
SPELL("levitation",      "tan",
      P_ESCAPE_SPELL,      20,  4, 1, NODIR, CLR_BROWN,
                                                        SPE_LEVITATION),
SPELL("extra healing",   "plaid",
      P_HEALING_SPELL,     27,  3, 1, IMMEDIATE, CLR_GREEN,
                                                        SPE_EXTRA_HEALING),
SPELL("restore ability", "light brown",
      P_HEALING_SPELL,     25,  3, 1, NODIR, CLR_BROWN,
                                                        SPE_RESTORE_ABILITY),
SPELL("invisibility",    "dark brown",
      P_ESCAPE_SPELL,       0,  1, 1, NODIR, CLR_BROWN,
                                                        SPE_INVISIBILITY),
SPELL("detect treasure", "gray",
      P_DIVINATION_SPELL,  20,  4, 1, NODIR, CLR_GRAY,
                                                        SPE_DETECT_TREASURE),
...
SPELL("turn undead",     "copper",
      P_CLERIC_SPELL,      16,  2, 1, IMMEDIATE, HI_COPPER,
                                                        SPE_TURN_UNDEAD),
SPELL("polymorph",       "silver",
      P_MATTER_SPELL,      10,  6, 1, IMMEDIATE, HI_SILVER,
                                                        SPE_POLYMORPH),
SPELL("teleport away",   "gold",
      P_ESCAPE_SPELL,      15,  6, 1, IMMEDIATE, HI_GOLD,
                                                        SPE_TELEPORT_AWAY),
SPELL("create familiar", "glittering",
      P_CLERIC_SPELL,      10,  6, 1, NODIR, CLR_WHITE,
                                                        SPE_CREATE_FAMILIAR),
SPELL("cancellation",    "shining",
      P_MATTER_SPELL,      15,  7, 1, IMMEDIATE, CLR_WHITE,
                                                        SPE_CANCELLATION),
SPELL("protection",      "dull",
      P_CLERIC_SPELL,      18,  1, 1, NODIR, HI_PAPER,
                                                        SPE_PROTECTION),
SPELL("jumping",         "thin",
      P_ESCAPE_SPELL,      20,  2, 1, IMMEDIATE, HI_PAPER,
                                                        SPE_JUMPING),
...
WAND("create monster",  "maple", 50, 200, 1, NODIR, WOOD, HI_WOOD,
                                                    WAN_CREATE_MONSTER),
WAND("wishing",          "pine",  0,5000, 1, NODIR, WOOD, HI_WOOD,
                                                    WAN_WISHING),
 ...
 */
ROCK("luckstone", "gray",
     0,  10,  10, 60, 3, 3, 1, 10, 7, 1, 0, MINERAL, CLR_GRAY, LUCKSTONE),
ROCK("touchstone", "gray",
     0,   8,  10, 45, 3, 3, 0, 10, 6, 1, 0, MINERAL, CLR_GRAY, TOUCHSTONE),
ROCK("thiefstone", "gray",
     0,  10,  10, 60, 3, 3, 1, 10, 6, 0, 1, MINERAL, CLR_GRAY, THIEFSTONE),
ROCK("flint", "gray",
     0,  10,   2,  1, 6, 6, 0, 10, 7, 1, 0, MINERAL, CLR_GRAY, FLINT),
ROCK("rock", NoDes,
     1, 100,  10,  0, 3, 3, 0, 10, 7, 1, 0, MINERAL, CLR_GRAY, ROCK),
#undef GEM
#undef ROCK
