...
/* P:pfx, ln, opt_*, setwhere?, negateok?, valok?, dupok?, hndlr? Alias, desc*/
 ...
 /* NHOPTC(align) -- moved to top */
    ...
    NHOPTB(checkpoint, Advanced, 0, opt_out, set_in_config,
           On, No, No, No, NoAlias, (boolean *) 0, Term_False,
           (char *)0)
#endif
 ...
 /* NHOPTC(gender) -- moved to top */
    ...
    NHOPTB(guicolor, Advanced, 0, opt_out, set_in_game,
           ...
           "use color for UI")
    NHOPTB(hallucinating, Advanced, 0, opt_in, set_in_config, Off, Yes, No, No,
           "hallu", &u.uroleplay.hallu, Term_False,
    ...
    NHOPTO("monster colors", Advanced, o_monstercolor, BUFSZ,
                opt_in, set_in_game,
 ...
 /* NHOPTC(name) -- moved to top */
    ...
    NHOPTC(orientation, Advanced, 12, opt_in, set_gameview, No, Yes, No, No,
 ...
 /* NHOPTC(playmode) -- moved to top */
    NHOPTC(polyinit, Advanced, 30, opt_in, set_in_config, No, Yes, No, No,
                NoAlias,
