...
/* P:pfx, ln, opt_*, setwhere?, negateok?, valok?, dupok?, hndlr? Alias, desc*/
    ...
    NHOPTB(guicolor, 0, opt_out, set_in_game, On, Yes, No, No,  NoAlias,
                &iflags.wc2_guicolor)
    NHOPTB(hallucinating, 0, opt_in, set_in_config, Off, Yes, No, No, "hallu",
                &u.uroleplay.hallu)
...
#endif
    NHOPTB(hilite_hidden_stairs, 0, opt_out, set_in_game, Off, Yes, No, No, NoAlias,
                &iflags.hilite_hidden_stairs)
    ...
    NHOPTC(orientation, 12, opt_in, set_gameview, No, Yes, No, No, "sexuality",
    ...
    NHOPTC(polyinit, 30, opt_in, set_in_config, No, Yes, No, No, NoAlias,
                "play the whole game as a monster (non-scoring)")
    ...
    NHOPTB(travel_debug, 0, opt_out, set_wizonly, Off, No, No, No, NoAlias,
                (boolean *) 0)
#endif
    NHOPTB(underline_peacefuls, 0, opt_out, set_in_game, On, Yes, No, No,
