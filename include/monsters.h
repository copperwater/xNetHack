 ...
 */
    ...
    MON("werejackal", S_DOG, LVL(2, 12, 7, 10, -7), (G_NOGEN | G_NOCORPSE),
        ...
        M2_NOPOLY | M2_WERE | M2_HOSTILE, M3_INFRAVISIBLE, 4, CLR_GREEN,
        WEREJACKAL),
    ...
    MON("werewolf", S_DOG, LVL(5, 12, 4, 20, -7), (G_NOGEN | G_NOCORPSE),
        A(ATTK(AT_BITE, AD_WERE, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(500, 250, MS_BARK, MZ_MEDIUM), MR_POISON | MR_SLEEP, 0,
        M1_NOHANDS | M1_POIS | M1_REGEN | M1_CARNIVORE,
        M2_NOPOLY | M2_WERE | M2_HOSTILE, M3_INFRAVISIBLE, 7, CLR_ORANGE,
        WEREWOLF),
    ...
    MON("Cerberus", S_DOG, LVL(15, 15, 2, 80, -7),
        (G_NOGEN | G_UNIQ | G_HELL),
        A(ATTK(AT_BITE, AD_PHYS, 5, 6), ATTK(AT_BITE, AD_DRCO, 3, 4),
          ATTK(AT_BITE, AD_FIRE, 5, 6), ATTK(AT_CLAW, AD_PHYS, 6, 6),
          ATTK(AT_CLAW, AD_PHYS, 6, 6), NO_ATTK),
        SIZ(1000, 350, MS_BARK, MZ_LARGE), MR_FIRE, MR_FIRE,
        M1_ANIMAL | M1_NOHANDS | M1_REGEN | M1_CARNIVORE,
        M2_NOPOLY | M2_HOSTILE | M2_STRONG | M2_PNAME | M2_MALE,
        M3_INFRAVISIBLE, 20, CLR_RED, CERBERUS),
    /*
     * eyes
     */
    ...
    MON("floating eye", S_EYE, LVL(2, 1, 9, 10, 0), (G_GENO | 5),
        ...
        M2_HOSTILE | M2_NEUTER, M3_INFRAVISIBLE, 3, CLR_CYAN, FLOATING_EYE),
    ...
    MON("flaming sphere", S_EYE, LVL(6, 13, 4, 0, 0),
        ...
        M1_FLY | M1_BREATHLESS | M1_NOLIMBS | M1_NOHEAD | M1_MINDLESS
            | M1_NOTAKE,
        M2_HOSTILE | M2_NEUTER, M3_INFRAVISIBLE, 10, CLR_RED, FLAMING_SPHERE),
    MON("shocking sphere", S_EYE, LVL(6, 13, 4, 0, 0),
        ...
        M1_FLY | M1_BREATHLESS | M1_NOLIMBS | M1_NOHEAD | M1_MINDLESS
            | M1_NOTAKE,
        M2_HOSTILE | M2_NEUTER, M3_INFRAVISIBLE, 11, HI_ZAP, SHOCKING_SPHERE),
    ...
    MON("homunculus", S_IMP, LVL(2, 12, 6, 10, -7), (G_GENO | 2),
        ...
        MR_SLEEP | MR_POISON, M1_FLY | M1_POIS | M1_CARNIVORE, M2_STALK,
    ...
    MON("imp", S_IMP, LVL(3, 12, 2, 20, -7), (G_GENO | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(20, 10, MS_CUSS, MZ_TINY), 0, 0, M1_REGEN | M1_CARNIVORE,
        M2_WANDER | M2_STALK, M3_INFRAVISIBLE | M3_INFRAVISION, 4, CLR_ORANGE,
        IMP),
    ...
    MON("tengu", S_IMP, LVL(6, 13, 5, 30, 7), (G_GENO | 3),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, 7, CLR_CYAN, TENGU),
    MON("quasit", S_IMP, LVL(3, 18, 2, 20, -7), (G_GENO | G_SGROUP | 2),
        A(ATTK(AT_CLAW, AD_DRDX, 1, 4), ATTK(AT_CLAW, AD_DRDX, 1, 4),
          ATTK(AT_BITE, AD_PHYS, 1, 4), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(200, 200, MS_SILENT, MZ_SMALL), MR_POISON, MR_POISON,
        M1_REGEN | M1_CARNIVORE | M1_SEE_INVIS, M2_STALK,
        M3_INFRAVISIBLE | M3_INFRAVISION, 9, CLR_BLUE, QUASIT),
    /*
     * jellies
     */
    ...
    MON("leprechaun", S_LEPRECHAUN, LVL(5, 15, 8, 20, 0), (G_GENO | 4),
        ...
        M3_INFRAVISIBLE, 4, CLR_GREEN, LEPRECHAUN),
    /*
     * mimics
     */
    ...
    MON("mumak", S_QUADRUPED, LVL(10, 9, 0, 0, -2), (G_GENO | 1),
        ...
        M1_ANIMAL | M1_THICK_HIDE | M1_NOHANDS | M1_HERBIVORE,
        M2_HOSTILE | M2_STRONG, M3_INFRAVISIBLE, 15, CLR_GRAY, MUMAK),
    ...
    MON("sewer rat", S_RODENT, LVL(0, 12, 7, 0, 0), (G_GENO | G_SGROUP | 1),
        ...
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE | M1_CONCEAL, M2_HOSTILE,
        M3_INFRAVISIBLE, 1, CLR_BROWN, SEWER_RAT),
    ...
    MON("rabid rat", S_RODENT, LVL(2, 12, 6, 0, 0), (G_GENO | 1),
        ...
        M2_HOSTILE, M3_INFRAVISIBLE, 4, CLR_GREEN, RABID_RAT),
    MON("wererat", S_RODENT, LVL(2, 12, 6, 10, -7), (G_NOGEN | G_NOCORPSE),
        A(ATTK(AT_BITE, AD_WERE, 1, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(40, 30, MS_SQEEK, MZ_TINY), MR_POISON, 0,
        M1_NOHANDS | M1_POIS | M1_REGEN | M1_CARNIVORE,
        M2_NOPOLY | M2_WERE | M2_HOSTILE, M3_INFRAVISIBLE, 4, CLR_YELLOW,
        WERERAT),
    ...
    MON("couatl", S_ANGEL, LVL(8, 10, 5, 30, 7),
        ...
        SIZ(900, 400, MS_HISS, MZ_LARGE), MR_ELEC | MR_SLEEP | MR_POISON, 0,
    ...
    MON("Aleax", S_ANGEL, LVL(10, 8, 0, 30, 7), (G_NOHELL | G_NOCORPSE | 1),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, 12, CLR_GRAY, ALEAX),
    ...
    MON("shrieker", S_FUNGUS, LVL(3, 1, 7, 0, 0), (G_GENO | 1),
        ...
        M1_BREATHLESS | M1_NOEYES | M1_NOLIMBS | M1_NOHEAD | M1_MINDLESS
            | M1_NOTAKE,
        M2_HOSTILE | M2_NEUTER, 0, 2, CLR_BRIGHT_MAGENTA, SHRIEKER),
    ...
    MON("arch-lich", S_LICH, LVL(25, 9, -6, 90, -15),
        ...
        M1_BREATHLESS | M1_HUMANOID | M1_POIS | M1_REGEN,
        M2_UNDEAD | M2_HOSTILE | M2_MAGIC, M3_WANTSBOOK | M3_INFRAVISION,
        29, CLR_BRIGHT_MAGENTA, ARCH_LICH),
    /*
     * Mummies
     */
    MON("kobold mummy", S_MUMMY, LVL(3, 8, 6, 20, -2),
        (G_GENO | G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 4), ATTK(AT_TUCH, AD_WTHR, 1, 4),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(400, 50, MS_SILENT, MZ_SMALL), MR_COLD | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_POIS,
        M2_UNDEAD | M2_HOSTILE, M3_INFRAVISION, 7, CLR_BROWN, KOBOLD_MUMMY),
    MON("gnome mummy", S_MUMMY, LVL(4, 10, 6, 20, -3),
        (G_GENO | G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 6), ATTK(AT_TUCH, AD_WTHR, 1, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(650, 50, MS_SILENT, MZ_SMALL), MR_COLD | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_POIS,
        M2_UNDEAD | M2_HOSTILE | M2_GNOME, M3_INFRAVISION, 8, CLR_ORANGE,
        GNOME_MUMMY),
    MON("orc mummy", S_MUMMY, LVL(5, 10, 5, 20, -4),
        (G_GENO | G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 6), ATTK(AT_TUCH, AD_WTHR, 1, 8),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("red naga hatchling", S_NAGA, LVL(3, 10, 6, 0, 0), G_GENO,
        A(ATTK(AT_BITE, AD_PHYS, 1, 4),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(500, 100, MS_MUMBLE, MZ_SMALL), MR_FIRE | MR_POISON, MR_POISON,
     ...
     * Q - elves (Quendi)
     */
    MON("elf", S_ELF, LVL(10, 12, 10, 2, -3), G_NOGEN, /* for corpses */
        A(ATTK(AT_WEAP, AD_PHYS, 1, 8), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("Green-elf", S_ELF, LVL(5, 12, 10, 10, -6), (G_GENO | G_SGROUP | 2),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_ELF, 350, MS_HUMANOID, MZ_HUMAN), MR_SLEEP, MR_SLEEP,
        M1_HUMANOID | M1_OMNIVORE | M1_SEE_INVIS, M2_ELF | M2_COLLECT,
        M3_INFRAVISIBLE | M3_INFRAVISION, 7, CLR_BRIGHT_GREEN, GREEN_ELF),
    MON("Grey-elf", S_ELF, LVL(6, 12, 10, 10, -7), (G_GENO | G_SGROUP | 2),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_ELF, 350, MS_HUMANOID, MZ_HUMAN), MR_SLEEP, MR_SLEEP,
        M1_HUMANOID | M1_OMNIVORE | M1_SEE_INVIS, M2_ELF | M2_COLLECT,
    ...
    MON("pit viper", S_SNAKE, LVL(6, 15, 2, 0, 0), (G_GENO | 1),
        ...
        M1_SWIM | M1_CONCEAL | M1_NOLIMBS | M1_ANIMAL | M1_SLITHY | M1_POIS
            | M1_CARNIVORE | M1_OVIPAROUS | M1_NOTAKE,
        M2_HOSTILE, M3_INFRAVISION, 9, CLR_BLACK, PIT_VIPER),
    ...
    MON("troll", S_TROLL, LVL(7, 12, 4, 0, -3), (G_GENO | 2),
        ...
        SIZ(800, 350, MS_TROLL, MZ_LARGE), 0, 0,
    ...
    MON("ice troll", S_TROLL, LVL(9, 10, 2, 20, -3), (G_NOHELL | G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 6), ATTK(AT_CLAW, AD_COLD, 2, 6),
          ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1000, 300, MS_TROLL, MZ_LARGE), MR_COLD, MR_COLD,
        M1_HUMANOID | M1_REGEN | M1_CARNIVORE,
        M2_STRONG | M2_STALK | M2_HOSTILE, M3_INFRAVISIBLE | M3_INFRAVISION,
    ...
    MON("rock troll", S_TROLL, LVL(9, 12, 0, 0, -3), (G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 3, 6), ATTK(AT_CLAW, AD_PHYS, 2, 8),
          ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1200, 300, MS_TROLL, MZ_LARGE), MR_STONE, 0,
        M1_HUMANOID | M1_REGEN | M1_CARNIVORE,
    ...
    MON("water troll", S_TROLL, LVL(11, 14, 4, 40, -3), (G_NOGEN | G_GENO),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 8), ATTK(AT_CLAW, AD_PHYS, 2, 8),
          ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1200, 350, MS_TROLL, MZ_LARGE), 0, 0,
    ...
    MON("Olog-hai", S_TROLL, LVL(13, 12, -4, 0, -7), (G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 3, 6), ATTK(AT_CLAW, AD_PHYS, 2, 8),
          ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1500, 400, MS_TROLL, MZ_LARGE), 0, 0,
        M1_HUMANOID | M1_REGEN | M1_CARNIVORE,
        M2_STRONG | M2_STALK | M2_HOSTILE | M2_COLLECT,
    ...
    MON("genetic engineer", S_ABERRATION, LVL(12, 12, 3, 10, 0), (G_GENO | 1),
    ...
    MON("barrow wight", S_WRAITH, LVL(3, 12, 5, 5, -3),
        ...
        M2_UNDEAD | M2_STALK | M2_HOSTILE | M2_COLLECT, 0, 8, HI_ZAP,
        BARROW_WIGHT),
    ...
    MON("ghost", S_WRAITH, LVL(4, 5, 5, 80, -5), (G_NOCORPSE | G_NOGEN),
        ...
        M3_INFRAVISION | M3_NONCORPOREAL, 12, CLR_WHITE, GHOST),
    MON("shade", S_WRAITH, LVL(12, 10, 10, 0, 0), (G_NOCORPSE | G_NOGEN),
        ...
        M3_INFRAVISION | M3_NONCORPOREAL, 14, CLR_BLACK, SHADE),
    /*
     * Xorn
     */
    ...
    MON("owlbear", S_YETI, LVL(5, 12, 5, 0, 0), (G_GENO | 3),
        ...
        M1_ANIMAL | M1_HUMANOID | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG | M2_NASTY, M3_INFRAVISIBLE, 7, CLR_ORANGE,
        OWLBEAR),
    ...
    MON("sasquatch", S_YETI, LVL(7, 15, 6, 0, 2), (G_GENO | 1),
        ...
        M3_INFRAVISIBLE, 9, CLR_RED, SASQUATCH),
    /*
     * Zombies
     */
    ...
    MON("clay golem", S_GOLEM, LVL(11, 7, 7, 40, 0), (G_NOCORPSE | 1),
        ...
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_THICK_HIDE,
        M2_HOSTILE | M2_STRONG, 0, 12, CLR_ORANGE, CLAY_GOLEM),
    ...
    MON("glass golem", S_GOLEM, LVL(16, 6, 1, 50, 0), (G_NOCORPSE | 1),
        ...
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_THICK_HIDE,
        M2_HOSTILE | M2_STRONG, 0, 18, CLR_BRIGHT_CYAN, GLASS_GOLEM),
    ...
    MON("werejackal", S_HUMAN, LVL(2, 12, 10, 10, -7), (1),
        ...
        M1_HUMANOID | M1_POIS | M1_REGEN | M1_OMNIVORE,
        M2_NOPOLY | M2_WERE | M2_HOSTILE | M2_HUMAN | M2_COLLECT,
        M3_INFRAVISIBLE, 3, CLR_BROWN, HUMAN_WEREJACKAL),
    ...
    MON("lieutenant", S_HUMAN, LVL(10, 10, 10, 15, -4), (G_GENO | 1),
        ...
        SIZ(WT_HUMAN, 400, MS_SOLDIER, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE, M2_NOPOLY | M2_HUMAN | M2_MERC | M2_STALK
            | M2_LORD | M2_HOSTILE | M2_STRONG | M2_COLLECT,
    ...
    MON("captain", S_HUMAN, LVL(12, 10, 10, 15, -5), (G_GENO | 1),
        ...
        SIZ(WT_HUMAN, 400, MS_SOLDIER, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE, M2_NOPOLY | M2_HUMAN | M2_MERC | M2_STALK
            | M2_PRINCE | M2_HOSTILE | M2_STRONG | M2_COLLECT,
    ...
    MON("Wizard of Yendor", S_HUMAN, LVL(30, 12, -8, 100, A_NONE),
        (G_NOGEN | G_UNIQ),
        A(ATTK(AT_CLAW, AD_SAMU, 2, 12), ATTK(AT_WEAP, AD_PHYS, 2, 6),
        ...
        M2_NOPOLY | M2_HUMAN | M2_HOSTILE | M2_STRONG | M2_NASTY | M2_PRINCE
            | M2_MALE | M2_MAGIC,
        M3_COVETOUS | M3_WAITFORU | M3_INFRAVISIBLE, 34, HI_BOSS,
        WIZARD_OF_YENDOR),
    MON("Croesus", S_HUMAN, LVL(20, 15, 0, 40, 15), (G_UNIQ | G_NOGEN),
        ...
        M2_NOPOLY | M2_HUMAN | M2_STALK | M2_HOSTILE | M2_STRONG | M2_NASTY
            ...
            | M2_COLLECT | M2_MAGIC,
        M3_INFRAVISIBLE | M3_DISPLACES, 22, HI_LORD, CROESUS),
#ifdef CHARON
...
#define SEDUCTION_ATTACKS_NO                                      \
    ...
    MON("erinys", S_DEMON, LVL(7, 12, 2, 30, 10),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, 10, CLR_GREEN, ERINYS),
    MON("barbed devil", S_DEMON, LVL(8, 12, 0, 35, 8),
        (G_HELL | G_NOCORPSE | G_SGROUP | 2),
        A(ATTK(AT_CLAW, AD_PHYS, 2, 4), ATTK(AT_CLAW, AD_PHYS, 2, 4),
          ATTK(AT_STNG, AD_PHYS, 3, 4), ATTK(AT_NONE, AD_PHYS, 2, 4),
          NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_SILENT, MZ_HUMAN), MR_FIRE | MR_POISON, 0,
        M1_POIS | M1_THICK_HIDE, M2_DEMON | M2_STALK | M2_HOSTILE | M2_NASTY,
        M3_INFRAVISIBLE | M3_INFRAVISION, 10, CLR_CYAN, BARBED_DEVIL),
    MON("marilith", S_DEMON, LVL(7, 12, -6, 80, -12),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, 11, CLR_BRIGHT_CYAN, MARILITH),
    MON("vrock", S_DEMON, LVL(8, 12, 0, 50, -9),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, 11, CLR_ORANGE, VROCK),
    MON("hezrou", S_DEMON, LVL(9, 6, -2, 55, -10),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, 12, CLR_YELLOW, HEZROU),
    ...
    MON("Yeenoghu", S_DEMON, LVL(56, 18, -15, 80, -15),
        (G_HELL | G_NOCORPSE | G_NOGEN | G_UNIQ),
        A(ATTK(AT_WEAP, AD_PHYS, 5, 6), ATTK(AT_WEAP, AD_CONF, 2, 8),
        ...
        M3_WANTSAMUL | M3_INFRAVISIBLE | M3_INFRAVISION, 31, HI_BOSS,
        YEENOGHU),
    ...
    MON("Geryon", S_DEMON, LVL(72, 3, -3, 75, 15),
        ...
        M2_NOPOLY | M2_DEMON | M2_STALK | M2_HOSTILE | M2_PNAME | M2_NASTY
            | M2_PRINCE | M2_MALE,
        M3_WANTSAMUL | M3_INFRAVISIBLE | M3_INFRAVISION, 36, HI_BOSS,
        GERYON),
    MON("Dispater", S_DEMON, LVL(78, 15, -2, 80, 15),
        ...
        M2_NOPOLY | M2_DEMON | M2_STALK | M2_HOSTILE | M2_PNAME | M2_NASTY
            | M2_PRINCE | M2_MALE | M2_COLLECT,
        M3_WANTSAMUL | M3_INFRAVISIBLE | M3_INFRAVISION, 40, HI_BOSS,
        DISPATER),
    MON("Baalzebub", S_DEMON, LVL(89, 9, -5, 85, 20),
        (G_HELL | G_NOCORPSE | G_NOGEN | G_UNIQ),
        A(ATTK(AT_BITE, AD_PHYS, 6, 6), ATTK(AT_GAZE, AD_STUN, 2, 6),
          ATTK(AT_STNG, AD_DRST, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1500, 500, MS_BRIBE, MZ_LARGE), MR_FIRE | MR_POISON, 0,
        M1_FLY | M1_SEE_INVIS | M1_POIS,
        M2_NOPOLY | M2_DEMON | M2_STALK | M2_HOSTILE | M2_PNAME | M2_NASTY
            | M2_PRINCE | M2_MALE,
        M3_WANTSAMUL | M3_WAITFORU | M3_INFRAVISIBLE | M3_INFRAVISION,
        45, HI_BOSS, BAALZEBUB),
    MON("Asmodeus", S_DEMON, LVL(105, 12, -7, 90, 20),
        (G_HELL | G_NOCORPSE | G_NOGEN | G_UNIQ),
        A(ATTK(AT_CLAW, AD_PHYS, 4, 4), ATTK(AT_MAGC, AD_SPEL, 6, 6), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("Death", S_DEMON, LVL(30, 12, -5, 100, 0), (G_UNIQ | G_NOGEN),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_DISPLACES, 34, HI_BOSS,
        DEATH),
    ...
    MON("piranha", S_EEL, LVL(5, 18, 4, 0, 0),
        (G_GENO | G_NOGEN | G_SGROUP | 3),
     ...
     * quest nemeses
     */
    MON("Schliemann", S_HUMAN, LVL(16, 12, 0, 5, -14),
        (G_NOGEN | G_UNIQ),
        ...
        M1_TUNNEL | M1_NEEDPICK | M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_HUMAN | M2_MALE | M2_PNAME | M2_STALK | M2_HOSTILE
            | M2_STRONG | M2_NASTY | M2_GREEDY | M2_COLLECT | M2_MAGIC,
        M3_WANTSARTI | M3_WAITFORU | M3_INFRAVISIBLE,
        23, HI_LORD, SCHLIEMANN),
