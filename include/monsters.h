 ...
 */
    ...
    MON(NAM("giant fly"), S_ANT, LVL(1, 20, 3, 0, 0), G_NOGEN,
    ...
    MON(NAM("Cerberus"), S_DOG, LVL(15, 15, 2, 80, -7),
    ...
    MON(NAM("floating eye"), S_EYE,
        ...
        3, CLR_CYAN, FLOATING_EYE),
    MON(NAM("freezing sphere"), S_EYE,
        LVL(6, 13, 4, 0, 0), (G_NOCORPSE | G_NOHELL | G_GENO | 2),
        A(ATTK(AT_EXPL, AD_COLD, 4, 6), ATTK(AT_BOOM, AD_COLD, 4, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON(NAM("flaming sphere"), S_EYE,
        ...
        A(ATTK(AT_EXPL, AD_FIRE, 4, 6), ATTK(AT_BOOM, AD_FIRE, 4, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON(NAM("shocking sphere"), S_EYE,
        LVL(6, 13, 4, 0, 0), (G_NOCORPSE | G_GENO | 2),
        A(ATTK(AT_EXPL, AD_ELEC, 4, 6), ATTK(AT_BOOM, AD_ELEC, 4, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(10, 10, MS_SILENT, MZ_SMALL), MR_ELEC, MR_ELEC,
        M1_FLY | M1_BREATHLESS | M1_NOLIMBS | M1_NOHEAD | M1_MINDLESS
            | M1_NOTAKE,
        M2_HOSTILE | M2_NEUTER, M3_INFRAVISIBLE,
        11, HI_ZAP, SHOCKING_SPHERE),
    ...
    MON(NAM("imp"), S_IMP,
        ...
        M2_WANDER | M2_STALK, M3_INFRAVISIBLE | M3_INFRAVISION,
        4, CLR_ORANGE, IMP),
    ...
    MON(NAM("baluchitherium"), S_QUADRUPED,
        ...
        M1_ANIMAL | M1_THICK_HIDE | M1_NOHANDS | M1_HERBIVORE,
        M2_HOSTILE | M2_STRONG, M3_INFRAVISIBLE,
        15, CLR_ORANGE, BALUCHITHERIUM),
    MON(NAM("mumak"), S_QUADRUPED,
        LVL(10, 9, 0, 0, -2), (G_GENO | 1),
    ...
    MON(NAM("phoenix"), S_BAT,
        ...
        M2_WANDER | M2_STALK | M2_NASTY, M3_INFRAVISIBLE,
        20, CLR_ORANGE, PHOENIX),
    /*
     * Centaurs
     */
    ...
    MON(NAM("black mold"), S_FUNGUS,
        LVL(3, 0, 7, 0, 0), (G_GENO | 1),
    ...
    MON(NAM("Grey-elf"), S_ELF,
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION,
        8, CLR_GRAY, GREY_ELF),
    MON(NAMS("elf-lord", "elf-lady", "elf-noble"), S_ELF,
    ...
    MON(NAMS("Elvenking", "Elvenqueen", "elven monarch"), S_ELF,
     ...
     * Umber hulk
     */
    MON(NAM("umber hulk"), S_ABERRATION,
    ...
    MON(NAM("quantum mechanic"), S_ABERRATION,
    ...
    MON(NAM("mind flayer"), S_ABERRATION,
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION,
        13, CLR_MAGENTA, MIND_FLAYER),
    /* 3.7: from slash'em, to expand Q class; hit polymorphs target */
    MON(NAM("genetic engineer"), S_ABERRATION,
    ...
    MON(NAM("master mind flayer"), S_ABERRATION,
     ...
     */
    MON(NAM("ghost"), S_WRAITH,
        LVL(4, 5, 5, 80, -5), (G_NOCORPSE | G_NOGEN),
        ...
        M3_INFRAVISION | M3_NONCORPOREAL,
        12, CLR_WHITE, GHOST),
    MON(NAM("shade"), S_WRAITH,
    ...
    MON(NAM("owlbear"), S_YETI,
        ...
        7, CLR_ORANGE, OWLBEAR),
    MON(NAM("yeti"), S_YETI, LVL(5, 15, 6, 0, 0), (G_GENO | 2),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 6), ATTK(AT_CLAW, AD_PHYS, 1, 6),
          ATTK(AT_BITE, AD_PHYS, 1, 4), NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON(NAM("glass golem"), S_GOLEM,
        ...
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_THICK_HIDE,
        M2_HOSTILE | M2_STRONG, 0,
        18, CLR_BRIGHT_CYAN, GLASS_GOLEM),
    ...
    MON(NAM("lieutenant"), S_HUMAN,
        ...
        SIZ(WT_HUMAN, 400, MS_SOLDIER, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_HUMAN | M2_MERC | M2_STALK | M2_LORD | M2_HOSTILE
    ...
    MON(NAM("captain"), S_HUMAN,
        ...
        SIZ(WT_HUMAN, 400, MS_SOLDIER, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_HUMAN | M2_MERC | M2_STALK
...
#define SEDUCTION_ATTACKS_NO \
    ...
    MON(NAM("erinys"), S_DEMON,
        LVL(7, 12, 2, 30, 10), (G_HELL | G_NOCORPSE | G_NOGEN),
     ...
     */
    MON(NAM("Juiblex"), S_DEMON, LVL(50, 6, -7, 65, -15),
    ...
    MON(NAM("Asmodeus"), S_DEMON,
        ...
        A(ATTK(AT_CLAW, AD_PHYS, 4, 4), ATTK(AT_MAGC, AD_SPEL, 6, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON(NAM("jellyfish"), S_EEL,
        LVL(3, 3, 6, 0, 0), (G_GENO | G_NOGEN | 2),
    ...
    MON(NAM("piranha"), S_EEL,
        LVL(5, 18, 4, 0, 0), (G_GENO | G_NOGEN | G_SGROUP | 3),
        ...
        M1_SWIM | M1_AMPHIBIOUS | M1_ANIMAL | M1_SLITHY | M1_NOLIMBS
            | M1_CARNIVORE | M1_OVIPAROUS | M1_NOTAKE,
        M2_HOSTILE, 0,
        7, CLR_ORANGE, PIRANHA),
    MON(NAM("shark"), S_EEL,
        LVL(7, 12, 2, 0, 0), (G_GENO | G_NOGEN | 2),
    ...
    MON(NAM("giant eel"), S_EEL,
        LVL(5, 9, -1, 0, 0), (G_GENO | G_NOGEN | 4),
    ...
    MON(NAM("electric eel"), S_EEL,
        LVL(7, 10, -3, 0, 0), (G_GENO | G_NOGEN | 2),
    ...
    MON(NAM("kraken"), S_EEL,
        LVL(20, 3, 6, 0, -3), (G_GENO | G_NOGEN | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 2, 4), ATTK(AT_CLAW, AD_PHYS, 2, 4),
    ...
    MON(NAM("Chan-Sune Lama"), S_HUMAN,
     ...
     * quest nemeses
     */
    MON(NAM("Schliemann"), S_HUMAN,
        LVL(16, 12, 0, 5, -14), (G_NOGEN | G_UNIQ),
    ...
    MON(NAM("Master Kaen"), S_HUMAN,
        ...
        MR_POISON, M1_HUMANOID | M1_HERBIVORE | M1_SEE_INVIS | M1_WALLWALK,
    ...
    MON(NAM("Scorpius"), S_SPIDER,
        LVL(20, 18, 0, 50, -15), (G_NOGEN | G_UNIQ),
        A(ATTK(AT_CLAW, AD_SAMU, 2, 6), ATTK(AT_STNG, AD_DISE, 1, 4),
          ATTK(AT_HUGS, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1800, 350, MS_NEMESIS, MZ_HUGE), MR_POISON | MR_STONE, MR_POISON,
        M1_ANIMAL | M1_NOHANDS | M1_OVIPAROUS | M1_POIS | M1_CARNIVORE,
    ...
    MON(NAM("Anaraxis the Black"), S_HUMAN,
        ...
        M2_NOPOLY | M2_HUMAN | M2_STRONG | M2_PNAME | M2_HOSTILE | M2_STALK
            | M2_NASTY | M2_COLLECT | M2_MAGIC,
        M3_WANTSARTI | M3_WAITFORU | M3_INFRAVISIBLE,
        20, CLR_BLACK, ANARAXIS_THE_BLACK),
    /*
     * quest "guardians"
     */
