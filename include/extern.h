...
E int FDECL(artifact_hit, (struct monst *, struct monst *, struct obj *,
                           int *, int));
...
E void NDECL(passive_gold_detect);
...
E char *FDECL(adj_monnam, (struct monst *, const char *));
...
E int FDECL(tin_variety, (struct obj *, BOOLEAN_P));
...
E boolean FDECL(doorless_door, (int, int));
...
E char *FDECL(up_all_words, (char *));
...
E unsigned int FDECL(hash1, (int));
...
E boolean FDECL(doorlock, (struct obj *, struct monst *, int, int));
E int NDECL(doopen);
...
E void FDECL(bury_sink_ring, (XCHAR_P, XCHAR_P));
...
E const char* NDECL(ureflectsrc);
...
E void FDECL(make_paralyzed, (int, BOOLEAN_P, const char *));
...
E void FDECL(convert_line, (const char *,char *));
...
E char *FDECL(get_rnd_text, (const char *, char *, int, int FDECL((*), (int))));
...
E enum trap_immunities FDECL(immune_to_trap, (struct monst*, xchar));
