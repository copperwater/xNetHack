...
extern boolean permapoisoned(struct obj *) NO_NNARGS;
extern boolean arti_starts_with_the(struct obj *) NONNULLARG1;
...
extern boolean open_drawbridge(coordxy, coordxy);
...
extern int gold_detect(struct obj *, boolean) NONNULLARG1;
...
#endif
extern boolean create_pit_under(struct monst *, struct monst *);
...
extern int engraving_to_glyph(struct engr *) NONNULLARG1;
...
extern void moldy_corpse(union any *, long) NONNULLARG1;
...
extern boolean obj_aireffects(struct obj *, boolean) NONNULLARG1;
extern void restore_valk_locate(xint8);
...
extern struct monst *christen_monst(struct monst *, const char *) NONNULL
                                                                   NONNULLARG1;
extern struct obj *weapon_oname(struct obj *) NONNULLARG1;
...
extern char *adj_monnam(struct monst *, const char *) NONNULLARG1;
...
extern char *bogusmon(char *, char *, int) NONNULLARG1;
...
extern char *mon_wounds(struct monst *, boolean, boolean) NONNULLARG1;
extern void print_mon_wounded(struct monst *, int) NONNULLARG1;
...
extern void dragon_armor_handling(struct obj *, boolean, boolean) NO_NNARGS;
...
extern void keepdogs(boolean, boolean);
...
extern boolean tamedog(struct monst *, struct obj *, boolean, boolean) NONNULLARG1;
...
extern void find_level_beneath(const d_level *, d_level *) NONNULLARG12;
...
extern void format_monkiller(struct monst *) NONNULLARG1;
...
extern void mon_explodes_nodmg(struct monst *, struct attack *) NONNULLPTRS;
...
extern struct obj *ring_from_sink(coordxy, coordxy);
...
extern boolean doorlock(struct obj *, struct monst *, coordxy, coordxy) NONNULLARG12;
...
extern int monmaxhp(struct permonst *, uchar) NONNULLARG1;
...
extern int create_critters(int, struct permonst *, boolean,
                           struct monst *) NONNULLARG4;
...
extern const char *weaphitmsg(struct obj *, struct monst *) NONNULLARG12;
extern const char *barehitmsg(struct monst *) NONNULLARG1;
...
extern void piercer_hit(struct monst *, struct monst *) NONNULLARG12;
...
extern boolean boss_entrance(struct monst *) NONNULLARG1;
...
extern xint8 random_door_mask(int, boolean);
extern void clear_nonsense_doortraps(coordxy, coordxy);
extern int rand_roomtype(void);
...
extern void bury_sink_ring(coordxy, coordxy);
extern void mkfount(struct mkroom *);
extern void mksink(struct mkroom *);
extern void mkaltar(struct mkroom *);
extern void mkgrave(struct mkroom *);
extern void mktree(struct mkroom *);
...
extern void choose_thiefstone_loc(coord *) NONNULLARG1;
...
extern boolean has_stairs(struct mkroom *, boolean) NONNULLARG1;
...
extern boolean mon_wants_prop(struct permonst *, struct monst *) NONNULLARG12;
...
extern long mm_aggression(struct monst *, struct monst *) NONNULLARG12;
...
extern boolean faulty_lifesaver(struct obj *) NO_NNARGS;
...
extern void wakeup(struct monst *, boolean, boolean) NONNULLARG1;
...
extern boolean resists_light_halu(struct monst *) NONNULLARG1;
...
extern struct permonst *raceptr(struct monst *) NONNULLARG1;
extern boolean olfaction(struct permonst *) NONNULLARG1;
extern int monmaterial(int);
extern int emits_light(struct permonst *) NO_NNARGS;
extern boolean is_fleshy(const struct permonst *) NONNULLARG1;
...
#ifdef FUZZER_LOG
extern void fuzl_mtmp(const char *, struct monst *) NONNULLPTRS;
extern void fuzl_p2(const char *, const char *, struct monst *, const char *,
                    struct monst *) NONNULLPTRS;
extern void fuzl_xy(const char *, int, int) NONNULLARG1;
extern void fuzl_xyi(const char *, int, int, int)NONNULLARG1;
#endif
...
extern boolean mon_open_door(struct monst *, coordxy, coordxy) NONNULLARG1;
...
extern void put_monsters_to_sleep(struct monst *, int) NONNULLARG1;
...
extern short name_to_otyp(const char *) NONNULLARG1;
extern boolean object_not_monster(const char *) NONNULLARG1;
...
extern char *dragon_scales_color(struct obj *) NO_NNARGS;
...
#endif
extern boolean add_monstercolor(char *) NO_NNARGS;
...
extern boolean checkfile(char *, struct permonst *, unsigned, char *) NO_NNARGS;
...
extern boolean thiefstone_accepts(struct obj *, struct obj *) NONNULLARG12;
extern void thiefstone_teleport(struct obj *, struct obj *, boolean) NONNULLARG12;
extern boolean thiefstone_tele_mon(struct obj *, struct monst *) NONNULLARG12;
...
extern void tipcontainer(struct obj *) NONNULLARG1;
extern void dump_container(struct obj *, struct obj *, int) NONNULLARG1;
...
extern void ferment(union any *, long);
...
extern void scary_ghost(struct monst *) NONNULLARG1;
...
extern void leader_sees_qarti(struct obj *) NO_NNARGS;
...
extern void convert_line(const char *,char *);
...
extern int getroomtype(coordxy, coordxy);
...
extern int find_montype(lua_State *, const char *, int *) NONNULLARG2;
...
extern boolean in_splev_map(coordxy, coordxy);
...
extern void remove_outer_gear(struct monst *, struct obj *) NONNULLARG12;
...
extern boolean saddleable(struct permonst *) NONNULLARG1;
...
extern void water_damage_chain(struct obj *, boolean, int, boolean) NO_NNARGS;
...
/* doortrapped() 3rd argument can be null to mean player */
extern xint8 doortrapped(int, int, struct monst *, int, int, xint8) NO_NNARGS;
...
extern const char *attack_blocker(struct monst *) NONNULLARG1;
...
extern boolean cant_wield_corpse(struct obj *) NONNULLARG1;
...
extern void place_worm_seg(struct monst *, coordxy, coordxy) NONNULLARG1;
...
extern struct obj *which_armor(struct monst *, long) NO_NNARGS;
...
extern void extract_from_minvent(struct monst *, struct obj *, boolean,
                                 boolean) NONNULLARG12;
extern int armor_bonus(struct obj *) NO_NNARGS;
extern long armor_provides_extrinsic(struct obj *) NO_NNARGS;
...
extern void revive_egg(struct obj *) NONNULLARG1;
...
extern int adtyp_resistance_obj(struct monst *, int) NONNULLARG1;
extern boolean inventory_resistance_check(struct monst *, int);
