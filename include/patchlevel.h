...
#define COPYRIGHT_BANNER_A "xNetHack, Copyright 2017, based on NetHack, Copyright 1985-2015"
#define COPYRIGHT_BANNER_B "by Stichting Mathematisch Centrum and M. Stephenson. See license for details."
#define COPYRIGHT_BANNER_C "This is the base version. Experimental features will normally be listed here."
