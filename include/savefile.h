...
extern void sfo_version_info(NHFILE *, struct version_info *,
                                  const char *);
extern void sfo_wizard_puzzle(NHFILE *, struct wizard_puzzle *,
                                  const char *);
...
extern void sfi_version_info(NHFILE *, struct version_info *,
                                  const char *);
extern void sfi_wizard_puzzle(NHFILE *, struct wizard_puzzle *,
                                  const char *);
...
#define Sfo_wizard_puzzle(a,b,c) sfo_wizard_puzzle(a, b, c)
...
#define Sfi_wizard_puzzle(a,b,c) sfi_wizard_puzzle(a, b, c)
...
#define sfo(nhfp, dt, tag)                     \
  _Generic( (dt),                              \
    ...
    struct wizard_puzzle *: sfo_wizard_puzzle, \
    struct you *          : sfo_you            \
  ) (nhfp, dt, tag)
...
#define sfi(nhfp, dt, tag)                     \
  _Generic( (dt),                              \
    ...
    struct wizard_puzzle *: sfi_wizard_puzzle, \
    struct you *          : sfi_you            \
  ) (nhfp, dt, tag)
...
#define Sfo_wizard_puzzle(a,b,c) sfo(a, b, c)
...
#define Sfi_wizard_puzzle(a,b,c) sfi(a, b, c)
