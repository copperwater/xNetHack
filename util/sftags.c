...
struct nhdatatypes_t readtagstypes[] = {
    ...
    { NHTYPE_COMPLEX, (char *) "wizard_puzzle", sizeof(struct wizard_puzzle) },
...
const struct already_in_sfbase already[] = {
    ...
    { NHTYPE_COMPLEX, "Sfi_wizard_puzzle", "Sfi_x_wizard_puzzle" },
    ...
    { NHTYPE_COMPLEX, "Sfo_wizard_puzzle", "Sfo_x_wizard_puzzle" },
...
struct nh_classification nhdatatypes[] = {
    ...
    { 0, NHTYPE_COMPLEX, "sfi_wizard_puzzle", "sfi_wizard_puzzle" },
    ...
    { 0, NHTYPE_COMPLEX, "sfo_wizard_puzzle", "sfo_wizard_puzzle" },
